...
type Com_dot_vmware_dot_vshield_dot_edge_dot_sslvpn_dot_dto_dot_RadiusAuthServerDto struct {
	Ip         *Ip         `xml:" ip,omitempty" json:"ip,omitempty"`
...
type PrimaryAuthServers struct {
	...
	Com_dot_vmware_dot_vshield_dot_edge_dot_sslvpn_dot_dto_dot_RadiusAuthServerDto *Com_dot_vmware_dot_vshield_dot_edge_dot_sslvpn_dot_dto_dot_RadiusAuthServerDto `xml:" com.vmware.vshield.edge.sslvpn.dto.RadiusAuthServerDto,omitempty" json:"com.vmware.vshield.edge.sslvpn.dto.RadiusAuthServerDto,omitempty"`
